          ...
          <span className="relative z-0 inline-flex shadow-sm rounded-md">
            {
              auth.permissions.includes('edit-caselaw') && (
                <Link
                  ...
                  className="relative inline-flex items-center px-4 py-2 rounded-l-md border border-gray-300 bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 focus:z-10 focus:outline-none focus:ring-1 focus:ring-primary-500 focus:border-primary-500"
                >
                  Edit
                </Link>
              )
            }
            {
              auth.permissions.includes('delete-caselaw') && (
                <button
                  ...
                  className="-ml-px relative inline-flex items-center px-4 py-2 rounded-r-md border border-gray-300 bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 focus:z-10 focus:outline-none focus:ring-1 focus:ring-primary-500 focus:border-primary-500"
                >
                  Hapus
                </button>
              )
