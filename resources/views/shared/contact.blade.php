      ...
      <div class="grid grid-cols-1 lg:grid-cols-3">
        ...
        <div class="relative overflow-hidden py-10 px-6 bg-indigo-700 sm:px-10 xl:p-12">
          ...
          <ul role="list" class="mt-8 flex space-x-12">
            <li>
              <a class="text-indigo-200 hover:text-indigo-100" href="{{ $company->facebook_link }}" target="_blank">
            ...
            <li>
              <a class="text-indigo-200 hover:text-indigo-100" href="{{ $company->instagram_link }}" target="_blank">
            ...
            <li>
              <a class="text-indigo-200 hover:text-indigo-100" href="{{ $company->twitter_link }}" target="_blank">
